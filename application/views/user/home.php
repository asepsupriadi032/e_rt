...
<style type="text/css">
  header.masthead {
    ...
    background: -webkit-gradient(linear,left top,left bottom,from(rgba(92,77,66,.8)),to(rgba(92,77,66,.8))),url(<?php echo base_url('assets')?>/user/img/1.jpg) !important;
     background: linear-gradient(to bottom,rgba(92,77,66,.8) 0,rgba(92,77,66,.8) 100%),url(<?php echo base_url('assets')?>/user/img/1.jpg)!important; 
